  ...
  <div class="container-fluid bg-black text-white" style="height: 200vh;">
    ...
    <div class="row text-center align-items-center mt-4">
      <div class="col-12 text-center">
        <img src="assets/img_khoiron/pakponari.jpeg" width="300px" height="300px" />
        <h2 class="mt-2">Ponari Isno, S.E,</h2>
        <p>NIY=UBU.2009.01.57.201</p>
        <p>NIDN=0714117702</p>
        <p>Keterangan=Menagajar mata kuliah algoritma dan pemorgaman dasar di fakultas teknologi informaasi Universitas KH. Wahab Hasbullah Jombang</p>
      </div>
    </div>
  </div>
  <!-- div end -->
