  ...
  <div class="container-fluid bg-black text-white" style="height: 200vh;">
    ...
    <div class="row text-center align-items-center mt-4">
      <div class="col-12 text-center">
        <img src="assets/img_khoiron/paksujono.jpeg" width="300px" height="300px" />
        <h2 class="mt-2">Sujono, M.Kom</h2>
        <p>NIY=-</p>
        <p>NIDN=0725068804</p>
        <p>Keterangan=Menagajar mata kuliah sistem operasi dan elektronika dasar di fakultas teknologi informaasi Universitas KH. Wahab Hasbullah Jombang</p>
