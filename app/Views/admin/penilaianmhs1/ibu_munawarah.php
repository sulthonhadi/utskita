  ...
  <div class="container-fluid bg-black text-white" style="height: 200vh;">
    ...
    <div class="row text-center align-items-center mt-4">
      <div class="col-12 text-center">
        <img src="assets/img_khoiron/bumunawarah.jpeg" width="300px" height="300px" />
        <h2 class="mt-2">Munawaran, S.Kom, M.Si</h2>
        <p>NIY=UBU.2002.04.10804</p>
        <p>NIDN=0720107801</p>
        <p>Keterangan=Menagajar mata kuliah pengantar teknologi informasi di fakultas teknologi informaasi Universitas KH. Wahab Hasbullah Jombang</p>
