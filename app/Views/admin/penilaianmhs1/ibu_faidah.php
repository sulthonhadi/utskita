  ...
  <div class="container-fluid bg-black text-white" style="height: 200vh;">
    ...
    <div class="row text-center align-items-center mt-4">
      <div class="col-12 text-center">
        <img src="assets/img_khoiron/bu sufaidah.jpg" width="300px" height="300px" />
        <h2 class="mt-2">Siti sufidah, S.Kom, M.Si</h2>
        <p>NIY=UBU.2005.01.10804</p>
        <p>NIDN=0714128301</p>
        <p>Keterangan=Menagajar mata kuliah pengantar menejemen di fakultas teknologi informaasi Universitas KH. Wahab Hasbullah Jombang</p>
