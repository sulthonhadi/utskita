  ...
  <div class="container-fluid bg-black text-white" style="height: 200vh;">
    ...
    <div class="row text-center align-items-center mt-4">
      <div class="col-12 text-center">
        <img src="assets/img_khoiron/pak agus athok.jpeg" width="300px" height="300px" />
        <h2 class="mt-2">Achmad Agus Athok Miftachuddin, M.Kom</h2>
        <p>NIY=-</p>
        <p>NIDN=0724088904</p>
        <p>Keterangan=Menagajar mata kuliah praktikum Bahasa pemorgaman web 1 di fakultas teknologi informaasi Universitas KH. Wahab Hasbullah Jombang</p>
