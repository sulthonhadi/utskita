  ...
  <div class="container-fluid bg-black text-white" style="height: 200vh;">
    ...
    <div class="row text-center align-items-center mt-4">
      <div class="col-12 text-center">
        <img src="assets/img_khoiron/pak tholib.jpg" width="300px" height="300px" />
        <h2 class="mt-2">Tholib Hariono, S.Kom, M.Kom</h2>
        <p>NIY=UBU.2009.03.55-201</p>
        <p>NIDN=0709038301</p>
        <p>Keterangan=Menagajar mata kuliah basis data 1 dan basis data 2 di fakultas teknologi informaasi Universitas KH. Wahab Hasbullah Jombang</p>
