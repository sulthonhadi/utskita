        ...
        <div class="mt-4">
                <a href="http://localhost/uts/" class="text-white text-decoration-none d-flex align-items-center ms-4 " role="button">
                    ...
                    <ul class="nav collapse ms-1 flex-column" id="sidemenu" data-bs-parent="#menu">
                        ...
                        <li class="nav-item">
                            <a href="#" class="nav-link text-white" aria-current="page">IF-B</a>
                        </li>
                        <li class="nav-item">
...
<div class="oy mt-2">
  ...
  <ul class="dropdown-menu">
    <li><button class="dropdown-item" type="button">Genap Tahun 2023/2024</button></li>
  </ul>
    </div>
  ...
  <ul class="dropdown-menu">
    ...
    <li><a class="dropdown-item" href="http://localhost/uts/welcome/kedua">FAI</a></li>
    <li><a class="dropdown-item" href="http://localhost/uts/welcome/ketiga">FP</a></li>
    <li><a class="dropdown-item" href="http://localhost/uts/welcome/keempat">FE</a></li>
    <li><a class="dropdown-item" href="http://localhost/uts/welcome/kelima">FIP</a></li>
  </ul>
  </div>
