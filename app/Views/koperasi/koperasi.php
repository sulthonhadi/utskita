...
<div class="py-5">
    <div class="table-responsive datatables-wrapper">
        <table id="example" class="table table-striped table-hover border-1 caption-top text-center mt-3" style="background-color: var(--primary);width: 95%;margin:2.5%;height:65vh;">
...
<div class="container" style="display: flex;justify-content: center;align-items: center;width: 100%;">
    <div class="container_daytime" style="display: flex;width: 95vw;width: 80%;align-items: center;justify-content: center;flex-direction: column;margin-bottom: 0;">
        <div class="day">
            <h1 style="font-family: 'Kanit',sans-serif;font-size: 55px;font-weight:900;"><?php echo "$hari"; ?></h1>
        </div>
        <div class="time">
            <h5 style=";font-family: 'Kanit',sans-serif;font-size: 35px;font-weight: 900;"><?php echo "$waktu"; ?></h5>
        </div>
    </div>
</div>
