...
<style>
      <style>
body{
    background-image: url(https://unwaha.ac.id/wp-content/uploads/2022/12/Gedung-Baru-UNWAHA.jpg);
...
<body> 
 <div class="container mt-5" >
    <div class="row">
            <h1 class="text-center mb-5">BEASISWA UNWAHA NU</h1>
        </div>
    </div>
   </div> 
    <div class="row">
        <div class="col-md-6 offset-md-3">
            <form action="aksi_tambah.php" method="post">
                ...
                <div class="d-grid gap-2">
                     <a href="<?= base_url('/beasiswa1')?>" class="btn btn-primary btn-lg">Daftar</a>
                </div>
            </form>
			<br>
			<?php
